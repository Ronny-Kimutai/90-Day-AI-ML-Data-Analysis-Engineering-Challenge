...
- Advanced ML (XGBoost, LightGBM, Model Tuning)
- AI Applications in Energy & Electrical Systems
...
## 🧠 Daily Habit
- ⏱️ **1–2 hours** of coding or reading daily  
- ⚙️ Use **engineering datasets** whenever possible  
...
## ⚡ Recommended Engineering Datasets
You can source open datasets from:
- [Kaggle Energy Datasets](https://www.kaggle.com/datasets?search=energy)
